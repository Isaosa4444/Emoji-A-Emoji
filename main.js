...
classifier=ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/nO9D1fWGe/model.json", modelLoaded);
...
function speak(){
    ...
    speak_data_2="La primera prediccion es: "+ prediccion2;
